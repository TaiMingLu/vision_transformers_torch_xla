...
# Default drop_path rates by model size
# drop_path_by_size = dict(
#     mini = 0.05,    # or 0 for watchdog runs
#     ti = 0.1,
#     xs = 0.1,      # between ti and s, slightly higher for more params
#     s  = 0.1,       # 0.15 if 600–1000 epochs
#     m  = 0.15,      # after resizing head-dim to 64
#     b  = 0.2,       # 0.15 if strong AugReg
#     l  = 0.3        # back off to 0.25 on <300 epochs
# )
