...
from timm.models._registry import register_model, generate_default_cfgs, _model_entrypoints
...
def register_model_safe(fn):
    """Register model safely, suppressing warnings for known conflicts with system TIMM."""
    import warnings
    
    # Temporarily suppress the specific UserWarning about overwriting models
    with warnings.catch_warnings():
        warnings.filterwarnings("ignore", 
                              message="Overwriting .* in registry with .*", 
