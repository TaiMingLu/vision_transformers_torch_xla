...
# Also import timm registry as fallback for naflexvit models
import timm.models._registry as timm_registry
...
def create_model(
    ...
    if not is_model(model_name):
        # Fallback to timm registry for naflexvit models
        if timm_registry.is_model(model_name):
            create_fn = timm_registry.model_entrypoint(model_name)
        else:
